...
UCLASS()
class LYRAUINAVIGATION_API UGameSettingCollection : public UGameSetting
{
	GENERATED_BODY()
...
UCLASS()
class LYRAUINAVIGATION_API UGameSettingCollectionPage : public UGameSettingCollection
{
	GENERATED_BODY()
