 ...
 */
USTRUCT()
struct LYRAUINAVIGATION_API FGameSettingFilterState
{
	GENERATED_BODY()
 ...
 */
class LYRAUINAVIGATION_API FGameSettingEditableState
{
public:
 ...
 * visibility.
 */
class LYRAUINAVIGATION_API FGameSettingEditCondition : public TSharedFromThis<FGameSettingEditCondition>
{
public:
