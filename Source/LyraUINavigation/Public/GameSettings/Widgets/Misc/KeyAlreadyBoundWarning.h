 ...
 */
UCLASS(Abstract)
class LYRAUINAVIGATION_API UKeyAlreadyBoundWarning : public UGameSettingPressAnyKey
{
	GENERATED_BODY()
...
protected:
	UPROPERTY(BlueprintReadOnly, Category = "Key Already Bound", meta = (BindWidget, BlueprintProtected = true, AllowPrivateAccess = true))
