...
class LYRAUINAVIGATION_API UGameSettingListEntryBase : public UCommonUserWidget, public IUserObjectListEntry
{
	GENERATED_BODY()
...
class LYRAUINAVIGATION_API UGameSettingListEntry_Setting : public UGameSettingListEntryBase
{
	GENERATED_BODY()
...
UCLASS(Abstract, Blueprintable, meta = (Category = "Settings", DisableNativeTick))
class LYRAUINAVIGATION_API UGameSettingListEntrySetting_Discrete : public UGameSettingListEntry_Setting
{
	GENERATED_BODY()
...
UCLASS(Abstract, Blueprintable, meta = (Category = "Settings", DisableNativeTick))
class LYRAUINAVIGATION_API UGameSettingListEntrySetting_Scalar : public UGameSettingListEntry_Setting
{
	GENERATED_BODY()
...
UCLASS(Abstract, Blueprintable, meta = (Category = "Settings", DisableNativeTick))
class LYRAUINAVIGATION_API UGameSettingListEntrySetting_Action : public UGameSettingListEntry_Setting
{
	GENERATED_BODY()
...
UCLASS(Abstract, Blueprintable, meta = (Category = "Settings", DisableNativeTick))
class LYRAUINAVIGATION_API UGameSettingListEntrySetting_Navigation : public UGameSettingListEntry_Setting
{
	GENERATED_BODY()
